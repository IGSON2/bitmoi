...
func (c *Contract) ExecuteTransaction(method string, opts TransactOptions, args ...interface{}) (*common.Hash, error) {
...
func (c *Contract) CallContract(method string, args ...interface{}) ([]interface{}, error) {
	...
	out, err := c.client.CallContract(context.TODO(), ToCallArg(msg), nil)
	if err != nil {
		log.Error().
			Str("contract", c.contractAddress.String()).
			Err(err).
