...
func (s *PracScore) GetStage() int8             { return s.Stage }
...
func (s *PracScore) GetOuttime() string         { return s.Outtime }
...
func (s *CompScore) GetStage() int8             { return s.Stage }
...
func (s *CompScore) GetOuttime() string         { return s.Outtime }
